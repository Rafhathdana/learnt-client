...
export default function TabSection() {
  let [categories] = useState({
    ...
    Popular: [
      {
        id: 1,
        title: "The Impact of AI on Education: A Comprehensive Guide",
        date: "Jan 7",
        commentCount: 29,
        shareCount: 16,
      },
    ...
    Trending: [
      {
        id: 1,
        title: "Ask Me Anything: 10 answers to your questions about AI",
        date: "2d ago",
        commentCount: 9,
        shareCount: 5,
      },
      {
        id: 2,
        title: "Debunking Common Myths About Machine Learning",
        date: "4d ago",
        commentCount: 1,
        shareCount: 2,
      },
  ...
  return (
    <div>
      <SectionTitle
        title="Newsletter"
        description="Stay Ahead of the Learning Curve"
      />
      <HorizontalRule />
